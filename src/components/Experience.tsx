...
export default function Experience() {
  ...
  useGSAP(() => {
    ...
    const legends = gsap.timeline({
      defaults: { ease: "none" },
      scrollTrigger: {
        trigger: legendsRef.current,
        start: "top bottom",
        end: "bottom bottom",
        scrub: 1,
      },
    });
    legends.set({}, {}, LEGENDS_DURATION);

    setTimelines({ heroScrub, burst, fall, roll, radical, liquid, legends });
  });
